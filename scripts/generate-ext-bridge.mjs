#!/usr/bin/env node
/**
 * Generates extension bridge files based on csclaw-extensions.json and
...
const MANIFEST_PATH = resolve(ROOT, 'csclaw-extensions.json');
...
function generateMainBridge(manifest) {
  ...
  if (installedExts.length === 0) {
    return [
      ...
      '// To add extensions, configure csclaw-extensions.json and link the package.',
