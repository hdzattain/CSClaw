...
const LOCALHOST_FALLBACK_FLAG = 'csclaw:allow-localhost-fallback';
const SSE_FALLBACK_FLAG = 'csclaw:allow-sse-fallback';
const WS_DIAGNOSTIC_FLAG = 'csclaw:gateway-ws-diagnostic';
