 ...
 */
export const PORTS = {
  /** CSClaw GUI development server port */
  CSCLAW_DEV: 5173,
  
  /** CSClaw GUI production port (for reference) */
  CSCLAW_GUI: 23333,

  /** Local host API server port */
  CSCLAW_HOST_API: 13210,
...
export const APP_PATHS = {
  ...
  /** CSClaw configuration directory */
  CSCLAW_CONFIG: '~/.csclaw',
